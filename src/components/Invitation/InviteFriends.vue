<template>
  ...
  <div class="inviteFriends">
    ...
    <div class="content" style="position: relative; height: 9.72rem; width: 100%;">
      <div>
        <div class="photo-back photo-box" ref="photoBack">
          <img :src="require('../../assets/img/invitation/back2.png')" alt="" crossorigin="anonymous">
          <div class="photoimg"><img :src="erweima" alt="" crossorigin="anonymous"></div>
        </div>
      </div>
    ...
    <div class="footer">
      <a href="javascript:;" @click="isShare = true">邀约好友</a>
      <a href="javascript:;" @click="GeneratePoster">生成海报</a>
...
.photo-back {width: 6.46rem; height: 9.72rem; margin: .4rem auto; position: relative;}
.photo-back>img {width: 100%;}
.photo-back1 {width: 100%; height: 100%; position: absolute; top: 0; left: 0; opacity: 0; z-index: 2; display: none;}
.photoimg {width: 1.5rem; height: 1.5rem; position: absolute; bottom: .5rem; right: .8rem;}
.footer {width: 100%; height: 1.95rem; background: #fff; position: absolute; bottom: 0; left: 0; display: flex; justify-content: space-around; align-items: center; padding: 0 .5rem;}
.footer a {display: block; width: 2.58rem; height: .79rem; font-size: .34rem; color: #fff; text-align: center; line-height: .78rem; border-radius: .39rem;}
...
/*分享模块*/
.footer-share-modules{position: fixed;bottom: 0;width: 100%;height: 3.63rem;background-color: #F6F6F6;z-index: 999}
...
.footer-share-modules li{float: left;width: calc(100% / 5);text-align: center;position: relative; width: 20%;}
.footer-share-modules li img {width: 50%; display: inline-block;}
.footer-share-modules li p{width: 100%;text-align: center;top: .4rem;}
...
.footer-share-modules ul{border-bottom: .01rem solid #ccc; padding-bottom: .3rem}
